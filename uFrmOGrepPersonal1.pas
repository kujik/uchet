...
begin
  ...
  Frg1.Opt.SetFields([
    ['id$i','_id','40'],
    ['job','Наименование должности','250;h'],
    ['workersqnt','Количество работников, человек','120','f=#,##0:'],
    ['qnt1','Принято, чел.','80','f=#,##0:'],
    ['qnt2','Уволено, чел.','80','f=#,##0:'],
    ['qntvac','Потребность, чел.','120','f=#,##0:'],
    ['dtvac','Дата размещения вакансии','120','f=#,##0:']
  ]);
