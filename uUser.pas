...
uses
  ...
  Data.DBXOracle, Data.SqlExpr, frxTableObject, frxDBSet, Menus
  ;
...
begin
  Result:=(Pos(r, UserRights) > 0)
    and((r[1]='0')or(r[1]=InttoStr(cMainModule)));  //сбросим права, если они относятся к другим модулям (кроме тех что для Админки)
