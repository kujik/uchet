...
--логи
--во врем€ выполнени€ задани€ информаци€ в логе еще не по€витс€!
...
begin
  --обновим ссылки на стандартные издели€
  p_update_estimate_items_ref;
  --обновим в смета дату изменени€ вли€ющих смет 
  p_update_estimates_depend_dt;
  --обновим признаки готовности все вли€ющих смет дл€ данной 
