unit uFrmDehOrderComplaintReasons;
...
type
  TFrmDehOrderComplaintReasons = class(TCustomDropDownFormEh)
    DBGridEh1: TDBGridEh;
...
var
  FrmDehOrderComplaintReasons: TFrmDehOrderComplaintReasons;
...
procedure TFrmDehOrderComplaintReasons.Bt_CancelClick(Sender: TObject);
begin
  Close;
end;

procedure TFrmDehOrderComplaintReasons.Bt_OkClick(Sender: TObject);
begin
  ModalResult:=mrOk;
  Close;
end;

procedure TFrmDehOrderComplaintReasons.CustomDropDownFormEhCreate(Sender: TObject);
begin
...
procedure TFrmDehOrderComplaintReasons.CustomDropDownFormEhInitForm(
...
procedure TFrmDehOrderComplaintReasons.CustomDropDownFormEhReturnParams(
  Sender: TCustomDropDownFormEh; DynParams: TDynVarsEh);
var
  i: Integer;
  st: string;
...
procedure TFrmDehOrderComplaintReasons.DBGridEh1MouseDown(Sender: TObject;
