...
begin
  ...
  if (AddParam = THIS_IS_ORDER_ITEM) and (F.GetPropB('id_thn') = -100) then
    Exit;
  SetCaption;
...
begin
  SaveTable(FDrillingData, 'pnl_ops_Drilling', FDrillingData.GN('qnt_panels_with_drill').AsInteger <> nedtDrilling.Value, chbDrillingDataEntered);
