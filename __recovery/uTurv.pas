...
begin
  Q.QLoadFromQuery(
    'select id, null as pos1, 0 as pos2, dt_beg, dt_end, id_employee, id_job, grade, id_schedule, id_departament, id_organization, organization, is_trainee, is_foreman, is_concurrent, personnel_number, ' +
