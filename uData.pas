...
const
  ...
  myfrm_R_OrderStdItems_SelProdNStdItem='R_OrderStdItems_SelProdNStdItem';
...
const
  ...
  RouteFields : array [0..7] of string =
  ('КС','МТ','СТ','РК','ПГ','ЛК','КМ','ЭЛ')
  ;
...
const
  ...
  rOr_Rep_EstimatePrices='6-127';
  rOr_R_OrderProperties_Ch='6-128';
  ...
  URights : array [0..283] of array [0..3] of string = (
    ...
    (rPC_R_Sp_Change,'Модуль "Платежный календарь"','Справочник: Поставщики','Создание, изменение, удаление'),
    ...
    (rW_R_PersBonus_V,'Модуль "Работники"','Справочник: Персональные надбавки','Доступ к справочнику'),
    (rW_R_PersBonus_Ch,'Модуль "Работники"','Справочник: Персональные надбавки','Добавление, изменение, удаление'),
    ...
    (rW_J_Turv,'Модуль "Работники"','ТУРВ','Просмотр последних, внесение времени руководителя, премий (если пользователь выбран для подразделения)'),
    (rW_J_Turv_VAll,'Модуль "Работники"','ТУРВ','Просмотр ТУРВ за неограниченное время'),
    (rW_J_Turv_TP,'Модуль "Работники"','ТУРВ','Внесение времени ОК (по Парсеку), депремирования'),
    ...
    (rW_J_Payroll_V_Ceh,'Модуль "Работники"','Зарплатная ведомость','Просмотр расчетных ведомостей по цеху'),
    ...
    (rW_Rep_StaffSchedule_V,'Модуль "Работники"','Отчеты: Штатное расписание', 'Просмотр отчета, без данных о з/п'),
    (rW_Rep_StaffSchedule_V_S,'Модуль "Работники"','Отчеты: Штатное расписание', 'Просмотр отчета, включая данные по з/п'),
    ...
    (rW_Rep_StaffSchedule_Ch_SP,'Модуль "Работники"','Отчеты: Штатное расписание', 'Задание плановой з/п'),
    (rW_Rep_StaffSchedule_Ch_SS,'Модуль "Работники"','Отчеты: Штатное расписание', 'Задание з/п по рынку'),
    (rW_Rep_PayrollsSum,'Модуль "Работники"','Отчеты: Суммы по зарплатным ведомостям', 'Просмотр отчета'),
    ...
    (rOr_D_Order_Ch,'Модуль "Заказы"','Журналы: Заказы','Создание, изменение, проведение заказа'),
    (rOr_D_Order_UnApprove,'Модуль "Заказы"','Журналы: Заказы','Отмена проведения заказа'),
    (rOr_D_Order_Start,'Модуль "Заказы"','Журналы: Заказы','Запуск заказа'),
    (rOr_D_Order_Stop,'Модуль "Заказы"','Журналы: Заказы','Остановка заказа'),
    (rOr_D_Order_EditAll,'Модуль "Заказы"','Журналы: Заказы','Редактирование запущенного заказа'),
    (rOr_D_Order_Del,'Модуль "Заказы"','Журналы: Заказы','Удаление заказа'),
    (rOr_D_Order_Estimate_All,'Модуль "Заказы"','Журналы: Заказы','Обновление смет стандартных изедлий по всему заказу'),
    (rOr_D_Order_Estimate,'Модуль "Заказы"','Журналы: Заказы','Загрузка сметы к изделию'),
    ...
    (rOr_D_Order_EnteringAccount,'Модуль "Заказы"','Журналы: Заказы','Ввод данных счета'),
    ...
    (rOr_D_Order_SetCompletedM,'Модуль "Заказы"','Журналы: Заказы','Отметка завершения заказа менеджером (свой заказ)'),
    (rOr_D_Order_SetCompletedMA,'Модуль "Заказы"','Журналы: Заказы','Отметка завершения заказа менеджером (любой заказ)'),
    (rOr_D_Order_SetSn,'Модуль "Заказы"','Журналы: Заказы','Отметка заказа как обработанным снабжением'),
    (rOr_D_Order_EditDtOtgr,'Модуль "Заказы"','Журналы: Заказы','Ручной ввод плановой даты отгрузки'),
    ...
    (rOr_J_Orders_Set_Labor,'Модуль "Заказы"','Журналы: Заказы','Ввод трудоемкости'),
    ...
    (rOr_R_StdPspFormats_V,'Модуль "Заказы"','Справочники: Форматы стандартных изделий','Доступ к справочнику'),
    (rOr_R_StdPspFormats_Ch,'Модуль "Заказы"','Справочники: Форматы стандартных изделий','Создание, изменение, удаление записей'),
    ...
    (rOr_R_OrderProperties_Ch,'Модуль "Заказы"','Справочники:  Свойства заказов','Доступ к справочнику, ввод данных'),
    (rOr_R_OrderReglaments_V,'Модуль "Заказы"','Справочники:  Регламенты заказов','Доступ к справочнику'),
    (rOr_R_OrderReglaments_Ch,'Модуль "Заказы"','Справочники:  Регламенты заказов','Ввод данных'),
    ...
    (rOr_Rep_DataCheck,'Модуль "Заказы"','Отчеты','Отчет по проблемам в БД (несоответствия наименований и смет)'),
