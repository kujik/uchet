...
function xlSheetInsertCol(handle: SheetHandle; colFirst: Integer; colLast: Integer; updateNamedRanges: Integer): Integer cdecl;
external 'libxl' name 'xlSheetInsertColA';

function xlSheetInsertRow(handle: SheetHandle; rowFirst: Integer; rowLast: Integer; updateNamedRanges: Integer): Integer cdecl;
external 'libxl' name 'xlSheetInsertRowA';

function xlSheetRemoveCol(handle: SheetHandle; colFirst: Integer; colLast: Integer; updateNamedRanges: Integer): Integer cdecl;
external 'libxl' name 'xlSheetRemoveColA';

function xlSheetRemoveRow(handle: SheetHandle; rowFirst: Integer; rowLast: Integer; updateNamedRanges: Integer): Integer cdecl;
...
type
  ...
  public
    ...
    procedure insertCol(colFirst, colLast: Integer); overload;
    procedure insertCol(colFirst, colLast: Integer; updateNamedRanges: Boolean); overload;
    procedure insertRow(rowFirst, rowLast: Integer); overload;
    procedure insertRow(rowFirst, rowLast: Integer; updateNamedRanges: Boolean); overload;
    procedure removeCol(colFirst, colLast: Integer); overload;
    procedure removeCol(colFirst, colLast: Integer; updateNamedRanges: Boolean); overload;
    procedure removeRow(rowFirst, rowLast: Integer); overload;
    procedure removeRow(rowFirst, rowLast: Integer; updateNamedRanges: Boolean); overload;
    ...
    //!!!
    function readCell(row, col: Integer): Variant;
...
begin
  xlSheetInsertCol(handle, colFirst, colLast, 1);
end;

procedure TSheet.insertCol(colFirst, colLast: Integer; updateNamedRanges: Boolean);
begin
  xlSheetInsertCol(handle, colFirst, colLast, Integer(updateNamedRanges));
end;

procedure TSheet.insertRow(rowFirst, rowLast: Integer);
begin
  xlSheetInsertRow(handle, rowFirst, rowLast, 1);
end;

procedure TSheet.insertRow(rowFirst, rowLast: Integer; updateNamedRanges: Boolean);
begin
  xlSheetInsertRow(handle, rowFirst, rowLast, Integer(updateNamedRanges));
end;

procedure TSheet.removeCol(colFirst, colLast: Integer);
begin
  xlSheetRemoveCol(handle, colFirst, colLast, 1);
end;

procedure TSheet.removeCol(colFirst, colLast: Integer; updateNamedRanges: Boolean);
begin
  xlSheetRemoveCol(handle, colFirst, colLast, Integer(updateNamedRanges));
end;

procedure TSheet.removeRow(rowFirst, rowLast: Integer);
begin
  xlSheetRemoveRow(handle, rowFirst, rowLast, 1);
end;

procedure TSheet.removeRow(rowFirst, rowLast: Integer; updateNamedRanges: Boolean);
begin
  xlSheetRemoveRow(handle, rowFirst, rowLast, Integer(updateNamedRanges));
end;
...
////////////////////////////////////////////////////////////////////////////////
function TSheet.readCell(row, col: Integer): Variant;
begin
  case getCellType(row, col) of
    CELLTYPE_NUMBER: Result:=readNum(row, col);
    CELLTYPE_STRING: Result:=readStr(row, col);
    CELLTYPE_BOOLEAN: Result:=readBool(row, col);
    else Result:='';
  end;
end;
