...
возвращается айди пользователей через запятую и имена через точку с запятой
поддерживается копирование отметки в буфер и вставка из буфера
}
...
uses
  ...
  uString, uData, uMessages, uForms, uFrmBasicMdi, uFrmBasicGrid2, uFrDBGridEh, uFrmBasicEditabelGrid
  ;
