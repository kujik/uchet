...
uses
  ...
  FireDAC.Comp.DataSet, FireDAC.Comp.Client, DBGridEh.DBUtils;

type
  TFDDatasetFeaturesEh = class(TDBGridSQLDatasetFeaturesEh)
  private
  ...
  try
    ...
    begin
      ...
      begin
        ...
        oField := AGrid.DataSet.FieldByName(sFieldName);
...
Var
  ...
  oCol: TFDDatSColumn;
begin
  oDS := AGrid.DataSet as TFDAdaptedDataSet;
...
initialization
  ...
  RegisterDBGridDatasetFeaturesEh(TFDDatasetFeaturesEh, TFDQuery);
  RegisterDBGridDatasetFeaturesEh(TFDDatasetFeaturesEh, TFDStoredProc);
  RegisterDBGridDatasetFeaturesEh(TFDDatasetFeaturesEh, TFDTable);
  RegisterDBGridDatasetFeaturesEh(TFDDatasetFeaturesEh, TFDMemTable);
end.
