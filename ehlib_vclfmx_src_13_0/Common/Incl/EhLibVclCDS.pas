...
type
  ...
  TCDSDatasetFeaturesEh = class(TDBGridDatasetFeaturesEh)
  public
...
constructor TCDSDatasetFeaturesEh.Create;
begin
  inherited Create;

end;

function TCDSDatasetFeaturesEh.GetLocalFilterApplyingWay: TLocalFilterApplyingWayEh;
begin
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if SortOrder = TSortOrderEh.soDescEh then
...
begin
  ...
  begin
    ...
    begin
      ...
      if TDBGridEh(Sender).DataSet.Filter = '' then
        TDBGridEh(Sender).DataSet.Filter := '1=1';
  ...
  begin
    ...
    if DS <> nil then
    begin
      DatasetFeatures := GetDBGridDatasetFeaturesForDataSet(TDataSet(DS));
      if (DatasetFeatures <> nil) then
...
begin
  ...
  SrcCDS := AGrid.DataSet as TClientDataSet;
...
initialization
  RegisterDBGridDatasetFeaturesEh(TCDSDatasetFeaturesEh, TCustomClientDataSet);
end.
