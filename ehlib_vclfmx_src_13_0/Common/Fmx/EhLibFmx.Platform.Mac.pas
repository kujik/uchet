...
uses
  ...
  EhLibFmx.Platform,
  FMX.Platform.Mac, FMX.Helpers.Mac, Macapi.AppKit;
...
begin
  Result := NSColorToAlphaColor(TNSColor.Wrap(TNSColor.OCClass.darkGrayColor));
end;

function TEhLibPlatformWin.GetGridBackgroundColor: TAlphaColor;
begin
  Result := NSColorToAlphaColor(TNSColor.Wrap(TNSColor.OCClass.whiteColor));
end;

function TEhLibPlatformWin.GetGridFixedBackgroundColor: TAlphaColor;
begin
  Result := NSColorToAlphaColor(TNSColor.Wrap(TNSColor.OCClass.systemGrayColor));
end;
...
begin
  Result := NSColorToAlphaColor(TNSColor.Wrap(TNSColor.OCClass.grayColor));
end;
