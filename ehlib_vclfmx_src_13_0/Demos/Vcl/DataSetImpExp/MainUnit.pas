...
//  MemTableEh1.Next;
//  MemTableEh1.Edit;
//  TRefObjectField(MemTableEh1.FieldByName('RefFrameClass')).Value := TObject(TfrFramGridExporter);
//  MemTableEh1.Post;
...
//    MemTableEh1.Append;
//  MemTableEh1.Edit;
//  TRefObjectField(MemTableEh1.FieldByName('RefFrameClass')).Value := TObject(TfrDBGridHTMLExporter);
//  MemTableEh1.Post;
...
//    MemTableEh1.Append;
//  MemTableEh1.Edit;
//  TRefObjectField(MemTableEh1.FieldByName('RefFrameClass')).Value := TObject(TfrDBGridRTFExporter);
//  MemTableEh1.Post;
//
//  MemTableEh1.Next;
//  if MemTableEh1.Eof then
//    MemTableEh1.Append;
//  MemTableEh1.Edit;
//  TRefObjectField(MemTableEh1.FieldByName('RefFrameClass')).Value := TObject(TfrDBGridXLSXExporter);
//  MemTableEh1.Post;
