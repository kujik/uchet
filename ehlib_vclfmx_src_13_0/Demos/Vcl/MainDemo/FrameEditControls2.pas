...
uses
  ...
  EhLibVclUtils, ComCtrls, DBCtrlsEh, Mask;
...
begin
  ...
  gridFish.FieldColumns['Graphic'].FieldName := 'PngGraphic';
  DBImageEh2.DataField := 'PngGraphic';
  DBImageEh1.DataField := 'PngGraphic';
  {$ENDIF}
...
procedure TfrEditControls2.CreateWnd;
begin
  inherited CreateWnd;
  if (CustomStyleActive) then
  begin
    DBImageEh2.Color := clWindow;
    DBImageEh1.Color := clWindow;
  end else
  begin
    DBImageEh2.Color := clInfoBk;
    DBImageEh1.Color := clInfoBk;
  end;
end;
