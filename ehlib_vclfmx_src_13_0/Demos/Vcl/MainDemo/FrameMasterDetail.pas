...
uses
  ...
  ADODataDriverEh, MemTableEh, StdCtrls, DBAxisGridsEh, DynVarsEh, EhLibVclUtils;
...
procedure TfrMasterDetail.CreateWnd;
begin
  inherited CreateWnd;
  if (CustomStyleActive) then
  begin
    DBGridEh4.FieldColumns['ItemNo'].Color := clWindow;
  end else
  begin
    DBGridEh4.FieldColumns['ItemNo'].Color := $00F5EBE0;
  end;
end;
