object frCellButtons: TfrCellButtons
  Left = 0
  Top = 0
  Width = 614
  Height = 391
      ...
      item
        CellButtons = <
          item
            ...
            OnClick = DBGridEh1Columns0CellButtons0Click
            AutoFade = False
            HorzPlacement = ebhpInContentEh
            Caption = 'Edit'
            Margins.Left = 4
            Margins.Top = 1
            Margins.Right = 2
            Margins.Bottom = 1
            OnGetEnabledState = DBGridEh1Columns0CellButtons0GetEnabledState
            OnDraw = DBGridEh1Columns0CellButtons0Draw
          end
          item
            DrawBackTime = edbtAlwaysEh
            OnClick = DBGridEh1Columns0CellButtons1Click
            AutoFade = False
            HorzPlacement = ebhpInContentEh
            Caption = 'Post'
            Margins.Left = 2
            ...
            Margins.Right = 2
            Margins.Bottom = 1
            OnGetEnabledState = DBGridEh1Columns0CellButtons1GetEnabledState
            OnDraw = DBGridEh1Columns0CellButtons1Draw
          end
          item
            Style = ebsGlyphEh
            DrawBackTime = edbtAlwaysEh
            OnClick = DBGridEh1Columns0CellButtons2Click
            AutoFade = False
            HorzPlacement = ebhpInContentEh
            Caption = 'Cancel'
            Margins.Left = 2
            ...
            Margins.Right = 4
            Margins.Bottom = 1
            OnGetEnabledState = DBGridEh1Columns0CellButtons2GetEnabledState
            OnDraw = DBGridEh1Columns0CellButtons2Draw
          end>
        DynProps = <>
        EditButtons = <>
        Footers = <>
        Title.Alignment = taCenter
        Title.Caption = 'Edit/Post/Cancel'
        Width = 164
      end
      item
        CellButtons = <>
  ...
  object ImageList1: TImageList
    ...
    Top = 96
    Bitmap = {
      494C01010A008801040010001000FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
