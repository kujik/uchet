...
uses
  ...
  PivotGridsEh, DBAxisGridsEh, DBGridEh, EhLibVclUtils, GridsEh, ComCtrls, Mask,
  DBCtrlsEh, PivotGridToolsEh, SpreadGridsEh;
...
type
  TfrPivotGrid = class(TFrame)
    ...
    procedure PivotGridEh1DrawDataCell(Grid: TCustomPivotGridEh; ACol,
      ARow: Integer; var Params: TPivotCellDataValueDrawParamsEh;
...
begin
  ...
  bAddFieldsClick(nil);
  bLoadSourceDataClick(nil);
  bDefDefaultStructClick(nil);
  Button4Click(nil);
end;
...
begin
  ...
  MemTableEh1.LoadFromMemTableEh(MemTableEh2, 0, TLoadMode.lmAppend, []);
