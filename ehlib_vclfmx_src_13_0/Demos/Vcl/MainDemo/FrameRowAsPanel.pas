...
uses
  ...
  ExtCtrls, DBAxisGridsEh, DynVarsEh, EhLibVclUtils;
...
//    ScaleBy(Form1.PixelsPerInch, 96);
  ...
  DBGridEh5.FieldColumns['Graphic'].FieldName := 'PngGraphic';
  {$ENDIF}
end;
...
begin
  ...
  TBlobField(MemTableEh1.FieldByName('PngGraphic')).BlobType := ftGraphic;
end;
