...
uses
  ...
  EhLibVclUtils, GridsEh, DBAxisGridsEh, DBGridEh;
...
type
  TfrCellButtons = class(TFrame)
    ...
    procedure DBGridEh1Columns0CellButtons0Click(Sender: TObject;
      var Handled: Boolean);
    procedure DBGridEh1Columns0CellButtons1Click(Sender: TObject;
      var Handled: Boolean);
    procedure DBGridEh1Columns0CellButtons2Click(Sender: TObject;
      var Handled: Boolean);
    procedure DBGridEh1Columns0CellButtons0GetEnabledState(
      Grid: TCustomDBGridEh; Column: TColumnEh; CellButton: TDBGridCellButtonEh;
      var ButtonEnabled: Boolean);
    procedure DBGridEh1Columns0CellButtons1GetEnabledState(
      Grid: TCustomDBGridEh; Column: TColumnEh; CellButton: TDBGridCellButtonEh;
      var ButtonEnabled: Boolean);
    procedure DBGridEh1Columns0CellButtons0Draw(Grid: TCustomDBGridEh;
      Column: TColumnEh; CellButton: TDBGridCellButtonEh; Canvas: TCanvas; Cell,
      AreaCell: TGridCoord; const ARect: TRect;
      ButtonDrawParams: TCellButtonDrawParamsEh; var Handled: Boolean);
    procedure DBGridEh1Columns0CellButtons1Draw(Grid: TCustomDBGridEh;
      Column: TColumnEh; CellButton: TDBGridCellButtonEh; Canvas: TCanvas; Cell,
      AreaCell: TGridCoord; const ARect: TRect;
      ButtonDrawParams: TCellButtonDrawParamsEh; var Handled: Boolean);
    procedure DBGridEh1Columns0CellButtons2GetEnabledState(
      Grid: TCustomDBGridEh; Column: TColumnEh; CellButton: TDBGridCellButtonEh;
      var ButtonEnabled: Boolean);
    procedure DBGridEh1Columns0CellButtons2Draw(Grid: TCustomDBGridEh;
      Column: TColumnEh; CellButton: TDBGridCellButtonEh; Canvas: TCanvas; Cell,
      AreaCell: TGridCoord; const ARect: TRect;
      ButtonDrawParams: TCellButtonDrawParamsEh; var Handled: Boolean);
  private
...
procedure TfrCellButtons.DBGridEh1Columns0CellButtons0Click(Sender: TObject;
  var Handled: Boolean);
begin
  MemTableEh1.Edit;
end;

procedure TfrCellButtons.DBGridEh1Columns0CellButtons0Draw(
  Grid: TCustomDBGridEh; Column: TColumnEh; CellButton: TDBGridCellButtonEh;
  Canvas: TCanvas; Cell, AreaCell: TGridCoord; const ARect: TRect;
  ButtonDrawParams: TCellButtonDrawParamsEh; var Handled: Boolean);
begin
  if (MemTableEh1.State <> dsBrowse) then
    ButtonDrawParams.Font.Color := clGrayText;
end;

procedure TfrCellButtons.DBGridEh1Columns0CellButtons0GetEnabledState(
  Grid: TCustomDBGridEh; Column: TColumnEh; CellButton: TDBGridCellButtonEh;
  var ButtonEnabled: Boolean);
begin
  if (MemTableEh1.State = dsBrowse) then
...
procedure TfrCellButtons.DBGridEh1Columns0CellButtons1Click(Sender: TObject;
  var Handled: Boolean);
begin
  if (MemTableEh1.State = dsEdit) then
    MemTableEh1.Post;
end;

procedure TfrCellButtons.DBGridEh1Columns0CellButtons1Draw(
  Grid: TCustomDBGridEh; Column: TColumnEh; CellButton: TDBGridCellButtonEh;
  Canvas: TCanvas; Cell, AreaCell: TGridCoord; const ARect: TRect;
  ButtonDrawParams: TCellButtonDrawParamsEh; var Handled: Boolean);
begin
  if (MemTableEh1.State = dsEdit) and (MemTableEh1.RecNo = Grid.Row) then
    ButtonDrawParams.Font.Color := ButtonDrawParams.Font.Color
  else
    ButtonDrawParams.Font.Color := clGrayText;
end;

procedure TfrCellButtons.DBGridEh1Columns0CellButtons1GetEnabledState(
  Grid: TCustomDBGridEh; Column: TColumnEh; CellButton: TDBGridCellButtonEh;
  var ButtonEnabled: Boolean);
begin
  if (MemTableEh1.State = dsEdit) and (MemTableEh1.RecNo = Grid.Row) then
...
procedure TfrCellButtons.DBGridEh1Columns0CellButtons2Click(Sender: TObject;
  var Handled: Boolean);
begin
  if (MemTableEh1.State = dsEdit) then
    MemTableEh1.Cancel;
...
procedure TfrCellButtons.DBGridEh1Columns0CellButtons2Draw(
  Grid: TCustomDBGridEh; Column: TColumnEh; CellButton: TDBGridCellButtonEh;
  Canvas: TCanvas; Cell, AreaCell: TGridCoord; const ARect: TRect;
  ButtonDrawParams: TCellButtonDrawParamsEh; var Handled: Boolean);
begin
...
procedure TfrCellButtons.DBGridEh1Columns0CellButtons2GetEnabledState(
  Grid: TCustomDBGridEh; Column: TColumnEh; CellButton: TDBGridCellButtonEh;
  var ButtonEnabled: Boolean);
begin
  if (MemTableEh1.State = dsEdit) and (MemTableEh1.RecNo = Grid.Row) then
