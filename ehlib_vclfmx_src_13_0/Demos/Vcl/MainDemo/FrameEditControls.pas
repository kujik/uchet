...
uses
  ...
  Themes, EhLibVclUtils,
  {$IFDEF EH_LIB_6} Types, {$ENDIF}
  {$IFDEF EH_LIB_16} System.UITypes, {$ENDIF}
  Dialogs, DBGridEhGrouping, ToolCtrlsEh, DBGridEhToolCtrls, DBGridEh, ExtCtrls,
  StdCtrls, DBCtrlsEh, DBCtrls, DBLookupEh, GridsEh, Mask, MemTableDataEh, Db,
  MemTableEh, DataDriverEh, ADODB, ADODataDriverEh, ImgList, DBAxisGridsEh,
  DynVarsEh;
