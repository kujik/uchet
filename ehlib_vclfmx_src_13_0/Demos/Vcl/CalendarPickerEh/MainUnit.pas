...
//  Align := alClient;
  ...
  MemTableEh1.Next;
  MemTableEh1.Edit;
  TRefObjectField(MemTableEh1.FieldByName('RefFrameClass')).Value := TObject(TfrFrameTwoGrid);
  MemTableEh1.Post;

  MemTableEh1.Append;
  MemTableEh1.FieldByName('MenuName').AsString := '  Options';
  TRefObjectField(MemTableEh1.FieldByName('RefFrameClass')).Value := TObject(TfrFrame3_Options);
  MemTableEh1.Post;
...
initialization
  EhLibManager.DateTimeCalendarPickerHighlightHolidays := True;
