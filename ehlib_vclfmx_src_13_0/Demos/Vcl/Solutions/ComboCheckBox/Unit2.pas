...
uses
  ...
  DropDownFormEh, Dialogs, DynVarsEh, ToolCtrlsEh, MemTableDataEh, DB,
  DBGridEhGrouping, DBGridEhToolCtrls, EhLibVclUtils, GridsEh, DBAxisGridsEh,
  DBGridEh, MemTableEh, StdCtrls;
...
begin
  ...
  if VarIsArray(KeyValue) then
    Rows := VarArrayHighBound(KeyValue, 1) + 1;
