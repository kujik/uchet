...
uses
  ...
  GridsEh, DBGridEh, ComCtrls, MaskEdit, DBCtrlsEh, EhLibLclUtils,
  MemTableDataEh, Db, sqldb, odbcconn, MemTableEh, DataDriverEh,
...
begin
  ...
  DBEditEh1.Text := IntToStr((GetTickCountEh-ticks));
end;
