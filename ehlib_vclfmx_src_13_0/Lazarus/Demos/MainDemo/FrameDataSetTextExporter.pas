...
uses
  ...
  Themes, Variants,
  DataSetImpExpEh, DBGridEh,
  Dialogs, DBGridEhGrouping, ToolCtrlsEh, DBGridEhToolCtrls, ExtCtrls,
  GridsEh, MemTableDataEh, Db, sqldb, DataDriverEh,
  MemTableEh, StdCtrls, DynVarsEh, DBAxisGridsEh,
  ExtDlgs, DBCtrlsEh, EhLibJPegImage, MaskEdit, ComCtrls;
...
//    ImpExpList: TImpExpListEh;
    ...
    procedure FormatTextExportValue(Exporter: TComponent;
...
begin
  ...
  try
    ...
    for i := 0 to DBGridEh1.DataSet.Fields.Count-1 do
      mtFieldsMap.AppendRecord([
        DBGridEh1.DataSet.Fields[i].FieldName,
        DBGridEh1.DataSet.Fields[i].FieldName
        ]);
...
procedure TfrDataSetExporter.FormatTextExportValue(
  Exporter: TComponent; FieldsMapItem: TFieldsMapItemEh;
