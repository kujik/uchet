...
uses
  ...
  Db, ExtCtrls, ComCtrls, GridsEh, sqldb, buttons,
...
{$IFDEF EH_LIB_17} System.UITypes, {$ENDIF}
  ...
  DBVertGridsEh, DynVarsEh, DBCtrls, DBGridEh;
...
//  Panel1.ParentBackground := False;
  ...
  SQLDataDriverEh2.ConnectionProvider := Form1.SQLDBConnectionProviderEh1;
  MemTableEh1.Open;
end;
