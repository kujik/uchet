...
begin
  FormCreate(Sender);
  DBGridEh1.UpdateAllDataRowHeights;
end;
...
begin
  ...
  begin
    ...
    TextBlock.Font.Color := clHighlightText;
  end
  else
  begin
    TextBlock.Font.Style := [];
    TextBlock.Font.Color := clWindowText;
  end;
end;
