EhLib.VclFmx 12.1 Lazarus Edition

The current version of the library was tested under next platforms:

- Windows, Windows 7-10,  Lazarus 4.2 (rev lazarus_4_2) FPC 3.2.2 x86_64-win64-win32/win64
...
+TDBGridEh:
  ...
  Design-Time functional works partly:
    Moving columns does not work in Design-time.
