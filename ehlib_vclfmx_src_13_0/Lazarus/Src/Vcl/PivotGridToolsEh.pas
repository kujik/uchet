...
{$IFDEF EH_LIB_17} System.UITypes, {$ENDIF}
  ...
  {$ELSE}
    DBGridEh, Windows, UxTheme, CommCtrl,
  {$ENDIF}
  PivotGridsEh,
...
begin
  ...
  begin
    ...
    begin
      PivotFieldName := ADragCell.FieldNameForRowDetails.PivotField.FieldName;
      PivotDataSource.RowFields.Delete(FToolBox.RowFields.IndexOf(PivotFieldName));
    end else
    begin
      PivotFieldName := ADragCell.FieldNameForColDetails.PivotField.FieldName;
      PivotDataSource.ColumnFields.Delete(FToolBox.ColumnFields.IndexOf(PivotFieldName));
    end;
