...
(EhLib.VCL.BDE, EhLib.VCL.ADO, EhLib.VCL.CDS) to the 'uses' clause of the 
unit containing the DBGridEh
of your project and the grid will automatically sort the data in a DataSet.
EhLib.VCL... unit have code in the initialization part of the unit that
...
BDE               TQuery            EhLib.VCL.BDE.Pas
ADO               TADOQuery         EhLib.VCL.ADO.Pas     
ClientDataSet     TClientDataSet    EhLib.VCL.CDS.Pas
DBExpress         TSQLQuery         EhLib.VCL.DBX.Pas
InterBase Express TIBQuery          EhLib.VCL.IBX.Pas
