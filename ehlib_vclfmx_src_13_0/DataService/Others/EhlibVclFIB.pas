...
uses
 DBUtilsEh, DBGridEh.DBUtils, pFIBDataSet, DB, DBGridEh, ToolCtrlsEh, Classes, SysUtils;
...
begin
  ...
  begin
    ...
    begin
      ...
      fld[i].VInteger := TpFibDataset(Dataset).FBN(Grid.SortMarkedColumns[i].FieldName).Index;
