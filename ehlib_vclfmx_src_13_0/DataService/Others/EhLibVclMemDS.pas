...
uses
  DbUtilsEh, DBGridEh, DBGridEh.DBUtils, Db, MemDS, ToolCtrlsEh;

type
  TMemDatasetFeaturesEh = class(TDBGridDatasetFeaturesEh)
  public
...
initialization
  RegisterDBGridDatasetFeaturesEh(TMemDatasetFeaturesEh, TMemDataSet);
end.
