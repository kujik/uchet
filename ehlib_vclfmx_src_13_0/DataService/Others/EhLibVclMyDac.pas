...
uses
  DbUtilsEh, DBGridEh, DBGridEh.DBUtils, Db, MyAccess, VirtualTable, ToolCtrlsEh,
  Classes, System.SysUtils;
//  ,Vcl.Dialogs;

type

  TMyQuerySQLDatasetFeaturesEh = class(TDBGridSQLDatasetFeaturesEh)
  public
  ...
  TVirtualTableSQLDatasetFeaturesEh = class(TDBGridDatasetFeaturesEh)
  public
    procedure ApplyFilter(Sender: TObject; DataSet: TDataSet; IsReopen: Boolean); override;
  end;
...
initialization
  RegisterDBGridDatasetFeaturesEh(TMyQuerySQLDatasetFeaturesEh, TMyQuery);
  RegisterDBGridDatasetFeaturesEh(TVirtualTableSQLDatasetFeaturesEh, TVirtualTable);
end.
