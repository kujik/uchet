...
uses
  DbUtilsEh, DBGridEh, DBGridEh.DBUtils, Db, SQLMemMain, ToolCtrlsEh;

type

  TSQLMemTableDatasetFeaturesEh = class(TDBGridDatasetFeaturesEh)
  public
  ...
  TSQLMemQueryDataSetFeaturesEh = class(TDBGridSQLDatasetFeaturesEh)
  public
...
initialization
  RegisterDBGridDatasetFeaturesEh(TSQLMemTableDatasetFeaturesEh, TSQLMemTable);
  RegisterDBGridDatasetFeaturesEh(TSQLMemQueryDataSetFeaturesEh, TSQLMemQuery);
end.
