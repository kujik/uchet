...
uses
 DBUtilsEh, DBGridEh, DBGridEh.DBUtils, ToolCtrlsEh, DB, IBC, SysUtils;

type
  TIBDACDatasetFeaturesEh = class(TDBGridDatasetFeaturesEh)
  public
...
initialization
  ...
  RegisterDBGridDatasetFeaturesEh(TIBDACDatasetFeaturesEh, TCustomIBCDataSet);
