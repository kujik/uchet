...
{ TDBGridSQLDatasetFeaturesEh will try to find line in  }
...
uses
  Classes, DbUtilsEh, DBGridEh, DBGridEh.DBUtils, ToolCtrlsEh, SDEngine, Db, SysUtils;

type
  TSDSQLDatasetFeaturesEh = class(TDBGridSQLDatasetFeaturesEh)
  private
...
initialization
 ...
 RegisterDBGridDatasetFeaturesEh(TSDSQLDatasetFeaturesEh, TSDQuery);
 RegisterDBGridDatasetFeaturesEh(TSDSQLDatasetFeaturesEh, TSDMacroQuery); // delete for SQLDirect < v3.0
 RegisterDBGridDatasetFeaturesEh(TSDSQLDatasetFeaturesEh, TSDTable);      // delete for SQLDirect < v3.0
end.
