...
uses
  DbUtilsEh, DB, sysutils, DBGridEh, DBGridEh.DBUtils, Ora, OraSmart, StrUtils, MemTableDataEh;
...
type
  ...
  TODACSQLDatasetFeaturesEh = class(TDBGridSQLDatasetFeaturesEh)
  public
  ...
  TODACTableSQLDatasetFeaturesEh = class(TDBGridDatasetFeaturesEh)
  public
    procedure ApplySorting(Sender: TObject; DataSet: TDataSet; IsReopen: Boolean); override;
    procedure ApplyFilter(Sender: TObject; DataSet: TDataSet; IsReopen: Boolean); override;
  end;
...
initialization
  RegisterDBGridDatasetFeaturesEh(TODACSQLDatasetFeaturesEh, TOraQuery);
  RegisterDBGridDatasetFeaturesEh(TODACTableSQLDatasetFeaturesEh, TOraTable);
  RegisterDBGridDatasetFeaturesEh(TODACSQLDatasetFeaturesEh, TSmartQuery);
end.
