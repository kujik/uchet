...
{ TDBGridSQLDatasetFeaturesEh will try to find line in TADQuery.SQL string that     }
...
uses
  Classes, Db, SysUtils, DBGridEh.DBUtils,
  DbUtilsEh, DBGridEh, ToolCtrlsEh,
  uADCompDataSet, uADCompClient;

type
  TADDatasetFeaturesEh = class(TDBGridSQLDatasetFeaturesEh)
  private
...
initialization
  ...
  RegisterDBGridDatasetFeaturesEh(TADDatasetFeaturesEh, TADQuery);
  RegisterDBGridDatasetFeaturesEh(TADDatasetFeaturesEh, TADStoredProc);
  RegisterDBGridDatasetFeaturesEh(TADDatasetFeaturesEh, TADTable);
  RegisterDBGridDatasetFeaturesEh(TADDatasetFeaturesEh, TADMemTable);
