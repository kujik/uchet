...
uses
  DbUtilsEh, DBGridEh, DBGridEh.DBUtils, Db, ToolCtrlsEh, kbmMemTable;

type

  TkbmDatasetFeaturesEh = class(TDBGridDatasetFeaturesEh)
  public
...
initialization
  RegisterDBGridDatasetFeaturesEh(TkbmDatasetFeaturesEh, TkbmMemTable);
end.