...
{$IFDEF EH_LIB_6} Variants, {$ENDIF}
  DbUtilsEh, DBGridEh, DBGridEh.DBUtils, Db, Uni, SysUtils, ToolCtrlsEh;
...
type
  TUniDatasetFeaturesEh = class(TDBGridSQLDatasetFeaturesEh)
  public
...
initialization
  RegisterDBGridDatasetFeaturesEh(TUniDatasetFeaturesEh, TUniQuery);
  RegisterDBGridDatasetFeaturesEh(TUniDatasetFeaturesEh, TUniTable);
end.
